...
CREATE TYPE fonte_enum AS ENUM ('CAMARA', 'SENADO', 'TSE', 'ALESP', 'PORTAL_TRANSPARENCIA');

-- Ver V16. A localidade da emenda vem como texto livre em quatro formas, e
-- classificar na ingestão é o que permite declarar a lacuna sem reparsear
-- string a cada leitura.
